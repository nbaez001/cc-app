...
import { _tiposDocumento, _departamentos, _provincias, _distritos, _bancos, _estadosCuentaBanco } from 'src/app/common';
import { Proveedor } from 'src/app/model/config/proveedor.model';
...
export class RegProveedorComponent implements OnInit {
  ...
  agregar(): void {
    if (this.detFormularioGrp.valid) {
      ...
      this.validationService.setAsUntoched(this.detFormularioGrp, this.formErrors2, ['banco']);
