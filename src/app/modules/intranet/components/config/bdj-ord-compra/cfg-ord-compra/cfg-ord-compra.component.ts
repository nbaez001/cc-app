...
import { DetalleOrdenCompra } from 'src/app/model/config/detalle-orden-compra.model';
...
import { AfectacionPresOC } from 'src/app/model/config/afectacion-pres-oc.model';
