...
import { UNIDADES, TAMBOS, VEHICULOS, PRODUCTOSLUBRICANTE, deslizadores } from 'src/app/common';
...
@Component({
  selector: 'app-reg-lubricantes-afines3',
  templateUrl: './reg-lubricantes-afines3.component.html',
  styleUrls: ['./reg-lubricantes-afines3.component.scss']
})
export class RegLubricantesAfines3Component implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    public dialogRef: MatDialogRef<RegLubricantesAfines3Component>,
    private spinnerService: Ng4LoadingSpinnerService,
    @Inject(MAT_DIALOG_DATA) public data: Deslizador,
