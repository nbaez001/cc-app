...
import { RegDetMatVehiculoComponent } from '../control-mant-vehiculo/reg-det-mat-vehiculo/reg-det-mat-vehiculo.component';
...
export class ReqMantVehiculoComponent implements OnInit {
  ...
  salir(): void {
    this.router.navigate(['/intranet/control-mantenimiento']);
  }
